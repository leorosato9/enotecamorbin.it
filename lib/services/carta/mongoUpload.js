...
// Ripristiniamo la funzione di salvataggio singola e completa
export async function saveCartaToMongo({
  ...
  const record = {
    ...
    fascia,
    risultati,
    spiegazioni: spiegazioniJson, // Assumiamo che il JSON sia già un oggetto valido
    fileUrl,
    menuText,
    menuEmbedding,
    userPlan,
    createdAt: new Date(),
    status: 'completed', // Impostiamo lo stato direttamente a completato
    regenerationCount: 0,
    regenerationLimit
  };
...
// La funzione di aggiornamento per la rigenerazione rimane invariata
