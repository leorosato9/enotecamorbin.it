...
export async function saveCartaToMongo({ userId, userEmail, nome, regione, provincia, comune, fascia, risultati, spiegazioniJson, fileUrl, attivitaId, menuText, menuEmbedding }) {
...
export async function updateCartaInMongo({ cartaId, updatedRisultati, updatedSpiegazioni }) {
  ...
  console.log(`Il documento ${cartaId} è stato aggiornato.`);
}